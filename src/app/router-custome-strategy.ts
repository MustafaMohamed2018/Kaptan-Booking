import {ActivatedRouteSnapshot, DetachedRouteHandle, BaseRouteReuseStrategy, UrlSegment} from '@angular/router';
...
export class AppRouteReuseStrategy implements BaseRouteReuseStrategy {
  ...
  store(route: ActivatedRouteSnapshot, handle: DetachedRouteHandle): void {
    ...
    if (route.data.reuseComponent) this.storedHandles[id] = handle;
  }
